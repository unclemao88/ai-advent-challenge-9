...
The slider starts at 1.0, DeepSeek's own default. Like the response limit it
applies per call, so every role of a deliberate-reasoning run and both steps of
